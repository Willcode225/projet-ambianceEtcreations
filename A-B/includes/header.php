...
<head>
    ...
    <title>Ambiance Créations - Sublimez votre jardin</title>
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="service.php">Entretien & abattage</a>
                                <a href="service.php">Aménagement Extérieurs</a>
                                <a href="service.php">Pépinière</a>
                            </div>
                        </li>
                        <li><a href="nos-realisations.php">NOS RÉALISATIONS</a></li>
                        <li><a href="contact"><i class="fa-solid fa-address-book"></i>CONTACT</a></li>
                        <li><a href="connexion.php" class="btn-connect"><i class="fa-solid fa-user"></i>SE CONNECTER</a></li>
                    </ul>
                </div>
            </div>
        </nav>
